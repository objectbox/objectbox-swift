...
class StoreTests: XCTestCase {
    ...
    func testVersions() {
        ...
        XCTAssertGreaterThanOrEqual(Store.version, "5.2.0")
        XCTAssertGreaterThanOrEqual(Store.versionLib, "5.1.0")
        XCTAssertGreaterThanOrEqual(Store.versionCore, "5.1.1-2026-01-21")
    }
