...
class StoreTests: XCTestCase {
    ...
    func testVersions() {
        ...
        XCTAssertGreaterThanOrEqual(Store.version, "4.0.1")
        XCTAssertGreaterThanOrEqual(Store.versionLib, "4.0.2")
        XCTAssertGreaterThanOrEqual(Store.versionCore, "4.0.2-2024-10-15")
    }
