...
class StoreTests: XCTestCase {
    ...
    func testVersions() {
        ...
        XCTAssertGreaterThanOrEqual(Store.version, "5.1.1")
        XCTAssertGreaterThanOrEqual(Store.versionLib, "5.0.0")
        XCTAssertGreaterThanOrEqual(Store.versionCore, "5.0.0-2025-12-08")
    }
