...
class StoreTests: XCTestCase {
    ...
    func testVersions() {
        ...
        XCTAssertGreaterThanOrEqual(Store.version, "4.4.1")
        XCTAssertGreaterThanOrEqual(Store.versionLib, "4.3.1")
        XCTAssertGreaterThanOrEqual(Store.versionCore, "4.3.1-2025-08-02")
    }
