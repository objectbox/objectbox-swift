...
class QueryBuilderTests: XCTestCase {
    ...
    func testFindAll_OneEntity() throws {
        ...
        do {
            ...
            let query = personBox.query().build()
            let result: [TestPerson] = query.find()
    ...
    func testFindAll_ThreeEntities() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
    ...
    func testFindFirst_ThreeEntities() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
    ...
    func testFindFirst_WithCondition() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query { TestPerson.name == "Octavia" }.build()
        let result = query.first
        XCTAssertNotNil(result) // Cannot know which one without ordering.
    }
    ...
    func testFind_Null() {
        ...
        XCTAssertEqual(entityBox.query({ AllTypesEntity.string.isNil() }).build().count, 2)
        XCTAssertEqual(entityBox.query({ AllTypesEntity.string.isNotNil() }).build().count, 1)
        
        XCTAssertEqual(entityBox.query({ AllTypesEntity.integer.isNil() }).build().count, 0)
        XCTAssertEqual(entityBox.query({ AllTypesEntity.integer.isNotNil() }).build().count, 3)
        
        XCTAssertEqual(entityBox.query({ AllTypesEntity.double.isNil() }).build().count, 0)
        XCTAssertEqual(entityBox.query({ AllTypesEntity.double.isNotNil() }).build().count, 3)
    }
    ...
    func testCount_EmptyResults() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        
        let count = personBox.query().build().count
        XCTAssertEqual(count, 0)
    }
    
    func testCount_1Result() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
    ...
    func testFindWithOffset_EmptyResults() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        
        let result = personBox.query().build().find(offset: 0)
        XCTAssertEqual(result.count, 0)
    }
    
    func testFindWithOffset_ResultsBeforeOffset() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        
        XCTAssertNoThrow(try personBox.put([TestPerson(name: "Yancy", age: 123), TestPerson(name: "Butler", age: 234)]))
        
        let result = personBox.query().build().find(offset: 2)
        XCTAssertEqual(result.count, 0)
    }
    
    func testFindWithOffset_OffsetBetweenResults() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        
        let persons = [TestPerson(name: "Nnedi", age: 123), TestPerson(name: "Okorafor", age: 234)]
        XCTAssertNoThrow(try personBox.put(persons))
        
        let result = personBox.query().build().find(offset: 1)
        XCTAssertEqual(result.count, 1) // Sort order is undefined in this query
    }
    
    func testFindWithOffsetLimit_BetweenResults() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let result = personBox.query().build().find(offset: 1, limit: 2)
...
class QueryBuilderFindByPropertyEqualTests: XCTestCase {
    ...
    func testFind_Equals_Integer() {
        ...
        let result: [TestPerson] = query.build().find()
        XCTAssertEqual(result.count, 1)
    ...
    func testFind_Equals_Double() {
        ...
        let result: [AllTypesEntity] = query.build().find()
    ...
    func testFind_NotEquals_Integer() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query { TestPerson.age != 98 }.build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_NotEquals_String() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query { TestPerson.name != "Asimov" }.build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 2)
...
class QueryBuilderFindByPropertyGrLessTests: XCTestCase {
    ...
    func testFind_Less_Double() {
        ...
        let query = personBox.query { AllTypesEntity.double.isLessThan(123.457) }.build()
        let result: [AllTypesEntity] = query.find()
        XCTAssertEqual(result.count, 1)
    ...
    func testFind_Less_String() {
        ...
        let query = personBox.query { TestPerson.name < "Isaac" }.build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_Less_String_CaseSensitivity() {
        let personBox: Box<AllTypesEntity> = store.box(for: AllTypesEntity.self)
    ...
    func testFind_Less_Date() {
        ...
        let query = personBox.query { AllTypesEntity.date.isBefore(Date(timeIntervalSince1970: 500)) }.build()
        let result: [AllTypesEntity] = query.find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_Greater_Date() {
        ...
        let query = personBox.query { AllTypesEntity.date.isAfter(Date(timeIntervalSince1970: 500)) }.build()
        let result: [AllTypesEntity] = query.find()
        XCTAssertEqual(result.count, 1)
...
class QueryBuilderRangeTests: XCTestCase {
    ...
    func testFind_Between_Integer_PositiveAndNegative() {
        let personBox: Box<AllTypesEntity> = store.box(for: AllTypesEntity.self)
        ...
        let query = personBox.query { AllTypesEntity.integer.isBetween(-200, and: 50) }.build()
        let result: [AllTypesEntity] = query.find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_Between_Integer_BoundsExceedValues() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query { TestPerson.age.isBetween(5, and: 500) }.build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_Between_Integer_HigherValueFirst() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query { TestPerson.age.isBetween(500, and: 5) }.build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_Between_Integer_BoundsEqualValues() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query { TestPerson.age.isBetween(12, and: 98) }.build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_Between_Double_BoundsExceedValues() {
        let personBox: Box<AllTypesEntity> = store.box(for: AllTypesEntity.self)
        ...
        let query = personBox.query { AllTypesEntity.double.isBetween(20.0, and: 1000.0) }.build()
        let result: [AllTypesEntity] = query.find()
        XCTAssertEqual(result.count, 3)
    ...
    func testFind_Between_Double_HigherValueFirst() {
        let personBox: Box<AllTypesEntity> = store.box(for: AllTypesEntity.self)
        ...
        let query = personBox.query { AllTypesEntity.double.isBetween(400.8, and: 2.1) }.build()
        let result: [AllTypesEntity] = query.find()
        XCTAssertEqual(result.count, 3)
    ...
    func testFind_Between_Double_BoundsEqualValues() {
        let personBox: Box<AllTypesEntity> = store.box(for: AllTypesEntity.self)
        ...
        let query = personBox.query { AllTypesEntity.double.isBetween(123.457, and: 200.99) }.build()
        let result: [AllTypesEntity] = query.find()
        XCTAssertEqual(result.count, 2)
...
class QueryBuilderCollectionTests: XCTestCase {
    ...
    func testFind_InCollection_Integer() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query { TestPerson.age.isIn([1, 98, 12, 666]) }.build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_InCollection_String() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query { TestPerson.name.isIn(["Isaac", "Frank", "Herbert", "Asimov"]) }.build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_InCollection_Date() {
        let personBox: Box<AllTypesEntity> = store.box(for: AllTypesEntity.self)
        ...
        let query = personBox.query { AllTypesEntity.date.isIn(dates) }.build()
        let result: [AllTypesEntity] = query.find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_NotInCollection_Integer() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let result: [TestPerson] = personBox.query({ TestPerson.age.isNotIn([5, 1000, 98]) }).build().find()
        XCTAssertEqual(result.count, 1)
    ...
    func testFind_NotInCollection_Date() {
        let personBox: Box<AllTypesEntity> = store.box(for: AllTypesEntity.self)
        ...
        let result: [AllTypesEntity] = personBox.query({ AllTypesEntity.date.isNotIn(dates) }).build().find()
        XCTAssertEqual(result.count, 1)
    ...
    func testFind_StartsWith_String() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let result: [TestPerson] = personBox.query({ TestPerson.name.startsWith("Is") }).build().find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_StartsWith_String_CaseSensitivity() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
    ...
    func testFind_EndsWith_String() {
        ...
        let result = personBox.query({ TestPerson.name.endsWith("el") }).build().find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_EndsWith_String_CaseSensitivity() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
    ...
    func testFind_Contains_String() {
        ...
        let result = personBox.query({ TestPerson.name.contains("s") }).build().find()
        XCTAssertEqual(result.count, 1)
    ...
    func testFind_Contains_String_CaseSensitivity() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
...
class QueryBuilderOrderTests: XCTestCase {
    ...
    func testFind_OrderedAscending() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query { TestPerson.age != 98 }.ordered(by: TestPerson.age).build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_OrderedDescending() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query { TestPerson.age != 98 }.ordered(by: TestPerson.age, flags: .DESCENDING).build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 2)
    ...
    func testFind_AllOrderedDescending() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query().ordered(by: TestPerson.age, flags: .DESCENDING).build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 3)
    ...
    func testFind_AllOrderedAscending() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query().ordered(by: TestPerson.age).build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 3)
    ...
    func testFind_AllStringsOrderedDescending() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query().ordered(by: TestPerson.name, flags: .DESCENDING).build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 3)
    ...
    func testFind_AllStringsOrderedAscending() {
        let personBox: Box<TestPerson> = store.box(for: TestPerson.self)
        ...
        let query = personBox.query().ordered(by: TestPerson.name).build()
        let result: [TestPerson] = query.find()
        XCTAssertEqual(result.count, 3)
...
class QueryBuilderAndOrOperatorTests: XCTestCase {
    ...
    func testOr_TwoConditions() {
        ...
        let result = personBox.query({ AllTypesEntity.string.startsWith("Thr")
    ...
    func testMixedOperators_ExplicitAndBeforeOr() {
        let personBox: Box<AllTypesEntity> = store.box(for: AllTypesEntity.self)
    ...
    func testMixedOperators_ExplicitAndAfterOr() {
        let personBox: Box<AllTypesEntity> = store.box(for: AllTypesEntity.self)
    ...
    func testMixedOperators_ImplicitAndBeforeOr() {
        let personBox: Box<AllTypesEntity> = store.box(for: AllTypesEntity.self)
