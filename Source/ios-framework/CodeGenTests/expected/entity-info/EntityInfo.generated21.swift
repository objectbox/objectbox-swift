...
extension WashingMachine: ObjectBox.EntityInspectable {
    ...
    fileprivate static func buildEntity(modelBuilder: ObjectBox.ModelBuilder) throws {
        ...
        try entityBuilder.addProperty(name: "dryerRack", type: PropertyType.string, id: 2, uid: 15616)
...
extension WashingMachine {
    ...
    internal static var dryerRack: Property<WashingMachine, String, Void> { return Property<WashingMachine, String, Void>(propertyId: 2, isPrimaryKey: false) }
    /// Generated entity property information.
    ///
    /// You may want to use this in queries to specify fetch conditions, for example:
    ///
...
internal class WashingMachineBinding: ObjectBox.EntityBinding {
    ...
    internal func collect(fromEntity entity: EntityType, id: ObjectBox.Id,
        ...
        let propertyOffset_dryerRack = propertyCollector.prepare(string: entity.dryerRack)
        let propertyOffset_destinationName = propertyCollector.prepare(string: entity.destinationName)

        propertyCollector.collect(id, at: 2 + 2 * 1)
        propertyCollector.collect(dataOffset: propertyOffset_dryerRack, at: 2 + 2 * 2)
