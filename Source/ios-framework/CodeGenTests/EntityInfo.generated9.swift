...
extension BusRoute: ObjectBox.EntityInspectable {
    ...
    fileprivate static func buildEntity(modelBuilder: ModelBuilder) throws {
        ...
        try entityBuilder.addProperty(name: "finalStop", type: String.entityPropertyType, id: 3, uid: 8416893018752217856)

        try entityBuilder.lastProperty(id: 3, uid: 8416893018752217856)
    }
}
...
extension BusRoute {
    ...
    /// You may want to use this in queries to specify fetch conditions, for example:
    ///
    ///     box.query { BusRoute.finalStop.startsWith("X") }
    internal static var finalStop: Property<BusRoute, String> { return Property<BusRoute, String>(propertyId: 3, isPrimaryKey: false) }
...
extension ObjectBox.Property where E == BusRoute {
    ...
    /// You may want to use this in queries to specify fetch conditions, for example:
    ///
    ///     box.query { .finalStop.startsWith("X") }

    static var finalStop: Property<BusRoute, String> { return Property<BusRoute, String>(propertyId: 3, isPrimaryKey: false) }
...
internal class BusRouteBinding: NSObject, ObjectBox.EntityBinding {
    ...
    internal func createEntity(entityReader: EntityReader, store: Store) -> EntityType {
        ...
        entity.finalStop = entityReader.read(at: 2 + 2 * 3)
