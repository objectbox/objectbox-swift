...
internal class BusRouteBinding: NSObject, ObjectBox.EntityBinding {
    ...
    internal func collect(fromEntity entity: EntityType, id: ObjectBox.Id,
        ...
        let propertyOffset_newProperty = propertyCollector.prepare(string: entity.newProperty)

        propertyCollector.collect(id, at: 2 + 2 * 1)
        propertyCollector.collect(dataOffset: propertyOffset_newProperty, at: 2 + 2 * 3)
    }
