...
extension WashingMachine {
    ...
    internal static var lineName: Property<WashingMachine, String> { return Property<WashingMachine, String>(propertyId: 2, isPrimaryKey: false) }
    /// Generated entity property information.
    ///
    /// You may want to use this in queries to specify fetch conditions, for example:
    ///
...
extension ObjectBox.Property where E == WashingMachine {
    ...
    static var lineName: Property<WashingMachine, String> { return Property<WashingMachine, String>(propertyId: 2, isPrimaryKey: false) }
