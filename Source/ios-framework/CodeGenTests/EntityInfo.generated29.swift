...
extension Autobus: ObjectBox.EntityInspectable {
    ...
    fileprivate static func buildEntity(modelBuilder: ModelBuilder) throws {
        ...
        try entityBuilder.addProperty(name: "id", type: Id<Autobus>.entityPropertyType, flags: [.id], id: 1, uid: 23552)
...
extension Autobus {
    ...
    internal static var id: Property<Autobus, Id<Autobus>> { return Property<Autobus, Id<Autobus>>(propertyId: 1, isPrimaryKey: true) }
    /// Generated entity property information.
    ///
    /// You may want to use this in queries to specify fetch conditions, for example:
    ///
    ///     box.query { Autobus.lineName.startsWith("X") }
    internal static var lineName: Property<Autobus, String> { return Property<Autobus, String>(propertyId: 2, isPrimaryKey: false) }
...
extension ObjectBox.Property where E == Autobus {
    ...
    static var id: Property<Autobus, Id<Autobus>> { return Property<Autobus, Id<Autobus>>(propertyId: 1, isPrimaryKey: true) }
    ...
    static var lineName: Property<Autobus, String> { return Property<Autobus, String>(propertyId: 2, isPrimaryKey: false) }
...
extension Building: ObjectBox.EntityInspectable {
    ...
    fileprivate static func buildEntity(modelBuilder: ModelBuilder) throws {
        ...
        try entityBuilder.addProperty(name: "id", type: Id<Building>.entityPropertyType, flags: [.id], id: 1, uid: 19712)
