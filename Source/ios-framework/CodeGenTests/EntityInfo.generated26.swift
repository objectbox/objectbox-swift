...
extension BusRoute: ObjectBox.EntityInspectable {
    ...
    fileprivate static func buildEntity(modelBuilder: ModelBuilder) throws {
        ...
        try entityBuilder.addProperty(name: "id", type: Id<BusRoute>.entityPropertyType, flags: [.id], id: 1, uid: 14592)
...
extension BusRoute {
    ...
    internal static var destinationName: Property<BusRoute, String> { return Property<BusRoute, String>(propertyId: 3, isPrimaryKey: false) }
...
extension ObjectBox.Property where E == BusRoute {
    ...
    static var destinationName: Property<BusRoute, String> { return Property<BusRoute, String>(propertyId: 3, isPrimaryKey: false) }
